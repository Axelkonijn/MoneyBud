...
| [03](03-context-and-scope.md) | Context and Scope | System boundary; who and what it talks to | **Filled** — §3.3 empty, needs deployment form |
...
| [07](07-deployment-view.md) | Deployment View | Where it runs | Empty — deployment form undecided |
| [08](08-crosscutting-concepts.md) | Cross-cutting Concepts | Rules applying everywhere — money handling lives here | Empty — §8.2 must be written before any money code |
...
| [12](12-glossary.md) | Glossary | Domain terms, defined once | **Filled** — one open question |
