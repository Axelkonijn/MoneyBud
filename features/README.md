...
Twelve feature files exist. Every scenario passes except those from the first demo feedback round,
which were **approved at the scenario gate on 2026-09-26** and are not bound yet: all of
`point-at-a-slice.feature`, and the new scenarios in `overview.feature`.
...
| The screen | `overview.feature`, `step-between-periods.feature`, `show-categories-in-a-period.feature`, `list-transactions-in-a-period.feature`, `suggest-categories.feature`, `point-at-a-slice.feature` — the last approved 2026-09-26, not yet bound |
